#pragma checksum "C:\Users\Admin\OneDrive\Documents\GraduationProject\GUI\Views\Language\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5823eef4ebdaaa9d7ab3c0a392cf58143f4b15d2"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5823eef4ebdaaa9d7ab3c0a392cf58143f4b15d2", @"/Views/Language/Index.cshtml")]
    ...
    public class Views_Language_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "C:\Users\Admin\OneDrive\Documents\GraduationProject\GUI\Views\Language\Index.cshtml"
    ...
    <div class=""section-body"">
        <div class=""row"">
            ...
            WriteLiteral(@"                      <i class=""fa-solid fa-angle-down hover-sort-down""></i>
                                    ...
                                    <ul class=""table-list"" id=""list_lang"">
            ...
            <div class=""col-12 col-md-4 col-lg-4 "" id=""create_lang"">
                <div class=""card"" id=""lang_form"">
                    <div class=""card-header"">
                        ...
                        <div class=""row "">
                            <div class=""col-12 col-md-12 col-lg-12"">
                                <div class=""form-group"">
                                    <label>Name</label>
                                    <input type=""text"" name=""name"" class=""form-control "" id=""lang_name""");
            ...
            WriteLiteral(@">
                            ...
                            <div class=""col-12 col-md-12 col-lg-12"">
                                <div class=""form-group"">
                                    <label>Status</label>
                                    <Select id=""lang_status"">
                                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5823eef4ebdaaa9d7ab3c0a392cf58143f4b15d214265", async() => {
                WriteLiteral("Active");
            }
            );
            ...
            WriteLiteral("\r\n                                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "5823eef4ebdaaa9d7ab3c0a392cf58143f4b15d215465", async() => {
            ...
            WriteLiteral(@"
                    ...
                    <div class=""card-footer text-right"">
                        <button class=""btn btn-primary"" onclick=""create_lang()"" type=""submit"">Submit</button>
                    </div>
                </div>
            </div>
...
<script>
        ...
        success: function (data) {
            $.each(data, function (key, value) {
                ...
                $('#list_lang').append(
                    ...
                    <li class=""body-table table-2"">");
            WriteLiteral(@"
                        <span onclick=""edit_lang_form('${value.id}')""><i class=""fa-solid icon-edit fa-pen-to-square""
                            id=""edit-role-icon"" ></i></span>
                        <span onclick=""delete_lang('${value.id}')""><i class=""fa-solid icon-remove fa-trash-can""
    ...
    function edit_lang(id) {
        ...
        var status = $(""#edit_lang_status"").val();
        $.ajax({
            url: ""http://localhost:57678/Languages/"",
            type: ""PUT"",
            contentType: ""application/json; charset=utf-8"",
    ...
    function edit_lang_form(id) {
        $.ajax({
            type: 'GET',
            url: ""http://localhost:57678/languages/""+id,
            success: function (data) {
                $('#lang_form').attr('style', 'display: none');
                $('#create_lang').append(
                    `<div class=""card"">
    ");
                        ...
                        <div class=""card-body"">
                            <div class=""row "">
                                ...
                                <div class=""col-12 col-md-12 col-lg-12"">
                                    <div class=""form-group"">
                                        <label>Name</label>
                                        <input type=""text"" name=""name"" class=""form-control "" id=""edit_lang_name"" required=""""
            ...
            WriteLiteral(@"                   <div class=""form-group"">
                        ...
                        <div class=""card-footer text-right"">
                            <button class=""btn btn-primary"" type=""submit"" onclick=""edit_lang('${data.id}')"">Submit</button>
                        </div>
                    </div>`
                );
                if (data.status == 'true') {
                    $('#edit_lang_status').append(
