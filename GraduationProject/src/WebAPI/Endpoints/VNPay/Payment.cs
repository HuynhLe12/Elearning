...
namespace WebAPI.Endpoints.VNPay
{
    public class Payment : BaseAsyncEndpoint
    {
        ...
        public async Task<ActionResult<string>> PaymentAsync ([FromBody]PaymentResponse data, CancellationToken cancellationToken = default)
        {
            string url = "http://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
            string returnUrl = "http://localhost:3000/payment/";
        ...
        public async Task<ActionResult<bool>> PayConfirmAsync(string Request, CancellationToken cancellationToken = default)
        {
            /*if (Request)
            {
